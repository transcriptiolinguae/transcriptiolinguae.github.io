export function validateOrReturnOriginal(originalWord, mappedString) {
  ...
  const allowedMappings = {  //  Creates a constant object. Think of it as a dictionary of legal pronunciations. The keys are letter sequences. The values are all IPA symbols those letters are allowed to represent. Example: a: ['a', 'ˈa', 'ˌa'], means The grapheme a may only correspond to a ˈa ˌa If it ever maps to i u ʃ ŋ the validator rejects the word. Example ci: ['tʃ', 'ˈtʃ'], means ci → tʃ is allowed. But ci → k would be rejected.
    ...
    ci: ['tʃ', 'ˈtʃ', 'tʃː', 'ˈtʃː'],
    cq: ['kː', 'ˈkː'], 
    c: ['k', 'ˈk', 'kː', 'ˈkː', 'tʃ', 'ˈtʃ', 'tʃː', 'ˈtʃː'],
    dd: ['dː', 'ˈdː'],
    d: ['d', 'ˈd', 'dː', 'ˈdː'],
    e: ['e', 'ˈe', 'eː', 'ˈeː', 'ɛ', 'ˈɛ', 'ɛː', 'ˈɛː'],
    è: ['e', 'ˈe', 'eː', 'ˈeː', 'ɛ', 'ˈɛ', 'ɛː', 'ˈɛː'],
    é: ['e', 'ˈe', 'eː', 'ˈeː', 'ɛ', 'ˈɛ', 'ɛː', 'ˈɛː'],
    ff: ['fː', 'ˈfː'],
    f: ['f', 'ˈf', 'fː', 'ˈfː'],
    gli: ['ʎ', 'ˈʎ', 'ʎː', 'ˈʎː'],
    ggh: ['gː', 'ˈgː'],
    ...
    gh: ['g', 'ˈg', 'gː', 'ˈgː'],
    gi: ['dʒ', 'ˈdʒ', 'dʒː', 'ˈdʒː'],
    g: ['g', 'ˈg', 'gː', 'ˈgː', 'dʒ', 'ˈdʒ', 'dʒː', 'ˈdʒː'],
    i: ['i', 'ˈi', 'iː', 'ˈiː', 'j', 'ˈj', 'jː', 'ˈjː'],
    ì: ['i', 'ˈi', 'iː', 'ˈiː', 'j', 'ˈj', 'jː', 'ˈjː'],
    í: ['i', 'ˈi', 'iː', 'ˈiː', 'j', 'ˈj', 'jː', 'ˈjː'],
    ll: ['lː', 'ˈlː'],
    l: ['l', 'ˈl', 'lː', 'ˈlː'],
    mm: ['mː', 'ˈmː'],
    m: ['m', 'ˈm', 'mː', 'ˈmː'],
    nn: ['nː', 'ˈnː'],
    n: ['n', 'ˈn', 'nː', 'ˈnː', 'ŋ', 'ˈŋ', 'ŋː', 'ˈŋː'],
    ho: ['o', 'ˈo', 'oː', 'ˈoː', 'ˌo', 'ɔ', 'ˈɔ', 'ɔː', 'ˈɔː', 'ˌɔ'],
    o: ['o', 'ˈo', 'oː', 'ˈoː', 'ɔ', 'ˈɔ', 'ɔː', 'ˈɔː'],
    ò: ['o', 'ˈo', 'oː', 'ˈoː', 'ɔ', 'ˈɔ', 'ɔː', 'ˈɔː'],
    ó: ['o', 'ˈo', 'oː', 'ˈoː', 'ɔ', 'ˈɔ', 'ɔː', 'ˈɔː'],
    pp: ['pː', 'ˈpː'],
    p: ['p', 'ˈp', 'pː', 'ˈpː'],
    q: ['k', 'ˈk', 'kː', 'ˈkː'],
    rr: ['rː', 'ˈrː'],
    ...
    ù: ['u', 'ˈu', 'uː', 'ˈuː', 'w', 'ˈw', 'wː', 'ˈwː'],
    ú: ['u', 'ˈu', 'uː', 'ˈuː', 'w', 'ˈw', 'wː', 'ˈwː'],
    vv: ['vː', 'ˈvː'],
    v: ['v', 'ˈv', 'vː', 'ˈvː'],
